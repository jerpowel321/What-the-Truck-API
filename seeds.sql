...
-- For The Love Of Ice Cream --
INSERT INTO Trucks (businessName, website, cuisine, menu, firstName, lastName, email, phone, address, city, state, zip, approved, applicationOpen, createdAt, updatedAt) VALUES ("For The Love Of Ice Cream", 'https://www.baskinrobbins.com/content/baskinrobbins/en.html', 'Dessert', 'https://www.baskinrobbins.com/content/baskinrobbins/en/products/icecream/flavors.html',  'David', 'Macarron', 'dmacarron@gmail.com', '4154637283', '310 Westlake Center', 'San Francisco', 'CA', '941007', true, false, '2019-05-31 17:50:26', '2019-05-31 17:50:26');

-- Burrito Heaven --
INSERT INTO Trucks (businessName, website, cuisine, menu, firstName, lastName, email, phone, address, city, state, zip, approved, applicationOpen, createdAt, updatedAt) VALUES ("Burrito Heaven", 'https://unodostacos.com/', 'Mexican', 'https://unodostacos.com/#menu',  'Jose', 'Garcia', 'jose.garcia@gmail.com', '4155736273', '595 Market St', 'San Francisco', 'CA', '941007', true, false, '2019-05-31 17:50:26', '2019-05-31 17:50:26');

-- A Night In Paris --
INSERT INTO Trucks (businessName, website, cuisine, menu, firstName, lastName, email, phone, address, city, state, zip, approved, applicationOpen, createdAt, updatedAt) VALUES ("A Night In Paris", 'http://ruelepicsf.com/', 'French', 'http://ruelepicsf.com/menu.php',  'Pierre', 'LaGrow', 'baguetteman@gmail.com', '4155557234', '900 Pine St,', 'San Francisco', 'CA', '941007', true, false, '2019-05-31 17:50:26', '2019-05-31 17:50:26');

-- Fit For A King Soup --
INSERT INTO Trucks (businessName, website, cuisine, menu, firstName, lastName, email, phone, address, city, state, zip, approved, applicationOpen, createdAt, updatedAt) VALUES ("Fit For A King Soup", 'https://boudinbakery.com/home/', 'Other', 'https://boudinbakery.com/menu/soups-chilis/',  'Peter', 'Spoon', 'psoon@yahoo.com', '4154528988', '750 Mission', 'San Francisco', 'CA', '941007', true, false, '2019-05-31 17:50:26', '2019-05-31 17:50:26');

-- Golden Palace --
INSERT INTO Trucks (businessName, website, cuisine, menu, firstName, lastName, email, phone, address, city, state, zip, approved, applicationOpen, createdAt, updatedAt) VALUES ("Golden Palace", 'https://www.pandaexpress.com/', 'Chinese', 'https://www.pandaexpress.com/menu',  'Kim', 'Chen', 'kchen@yahoo.com', '4154528988', '750 Mission', 'San Francisco', 'CA', '941007', true, false, '2019-05-31 17:50:26', '2019-05-31 17:50:26');

-- Jimmy's Pho-nomenal Pho --
INSERT INTO Trucks (businessName, website, cuisine, menu, firstName, lastName, email, phone, address, city, state, zip, approved, applicationOpen, createdAt, updatedAt) VALUES ("Jimmy's Pho-nomenal Pho", 'http://www.pho2000sf.com/', 'Vietnamese', 'http://www.pho2000sf.com/menu/',  'Jimmy', 'Tu', 'jimmy2@gmail.com', '4153334563', '750 Mission', 'San Francisco', 'CA', '941007', true, false, '2019-05-31 17:50:26', '2019-05-31 17:50:26');

-- Burger Boss --
INSERT INTO Trucks (businessName, website, cuisine, menu, firstName, lastName, email, phone, address, city, state, zip, approved, applicationOpen, createdAt, updatedAt) VALUES ("Burger Boss", 'https://www.shakeshack.com/', 'American', 'https://www.shakeshack.com/food-and-drink/',  'Taylor', 'Tanner', 'taytan@gmail.com', '4157328345', '750 Mission', 'San Francisco', 'CA', '941007', true, false, '2019-05-31 17:50:26', '2019-05-31 17:50:26');

-- Noah's Fried Dough-a --
INSERT INTO Trucks (businessName, website, cuisine, menu, firstName, lastName, email, phone, address, city, state, zip, approved, applicationOpen, createdAt, updatedAt) VALUES ("Noah's Fried Dough-a", 'https://www.krispykreme.com/', 'American', 'https://www.krispykreme.com/menu/doughnuts',  'Noah', 'Glasser', 'noah@gmail.com', '4154528988', '750 Mission', 'San Francisco', 'CA', '941007', true, false, '2019-05-31 17:50:26', '2019-05-31 17:50:26');

-- Rare Meats --
INSERT INTO Trucks (businessName, website, cuisine, menu, firstName, lastName, email, phone, address, city, state, zip, approved, applicationOpen, createdAt, updatedAt) VALUES ("Rare Meats", 'https://www.fossilfarms.com/', 'American', 'https://www.fossilfarms.com/products',  'John', 'Tucker', 'johntucker@gmail.com', '4155628994', '1 Main Street', 'San Francisco', 'CA', '941007', true, false, '2019-05-31 17:50:26', '2019-05-31 17:50:26');

-- Mel's Tesla Hunter --
INSERT INTO Trucks (businessName, website, cuisine, menu, firstName, lastName, email, phone, address, city, state, zip, approved, applicationOpen, createdAt, updatedAt) VALUES ("Mel's Tesla Hunter", 'https://www.fossilfarms.com/', 'French', 'https://www.fossilfarms.com/products',  'Melanie', 'Marsollier', 'melaniem@gmail.com', '415593850', '721 Market Street', 'San Francisco', 'CA', '941007', true, false, '2019-05-31 17:50:26', '2019-05-31 17:50:26');

-- Cyrus' Truck --
INSERT INTO Trucks (businessName, website, cuisine, menu, firstName, lastName, email, phone, address, city, state, zip, approved, applicationOpen, createdAt, updatedAt) VALUES ("Cyrus' Truck", 'https://oasisgrill.com/', 'Mediterranean', 'https://first.oasisgrill.com/',  'Cyrus', 'Ghadiri', 'cyrus@gmail.com', '415593850', '92 Market Street', 'San Francisco', 'CA', '941007', true, false, '2019-05-31 17:50:26', '2019-05-31 17:50:26');

-- Denis Hut Jr's --
INSERT INTO Trucks (businessName, website, cuisine, menu, firstName, lastName, email, phone, address, city, state, zip, approved, applicationOpen, createdAt, updatedAt) VALUES ("Denis Hut Jr's", 'https://www.benjerry.com/', 'Dessert', 'https://www.benjerry.com/flavors',  'Denis', 'Richie', 'richied@gmail.com', '4154738234', '92 Market Street', 'San Francisco', 'CA', '941007', true, false, '2019-05-31 17:50:26', '2019-05-31 17:50:26');

-- Jen's Pizza --
INSERT INTO Trucks (businessName, website, cuisine, menu, firstName, lastName, email, phone, address, city, state, zip, approved, applicationOpen, createdAt, updatedAt) VALUES ("Jen's Pizza", "https://pizzahub.cs/", "Italian", "https://pizzahub.ca/menu",  "Jennifer", "Powell", "jerpowel321@gmail.com", "415289976", "555 Mission", "San Francisco", "CA", "941007", true, false, "2019-05-31 17:50:26", "2019-05-31 17:50:26");

-- Mice-Cream Truck --
INSERT INTO Trucks (businessName, website, cuisine, menu, firstName, lastName, email, phone, address, city, state, zip, approved, applicationOpen, createdAt, updatedAt) VALUES ("Mice-Cream Truck", 'https://www.haagendazs.us/', 'Dessert', 'https://www.haagendazs.us/products',  'Larry', 'Smith', 'larrySmith@gmail.com', '4156564734', '92 Market Street', 'San Francisco', 'CA', '941007', true, false, '2019-05-31 17:50:26', '2019-05-31 17:50:26');
...
-- A Night In Paris --
INSERT INTO Reviews (truckName, userName, rating, comment, createdAt, updatedAt) VALUES ("A Night In Paris", "Sandra", 5, "The food was great and authentic.", "2019-06-02 18:50:40", "2019-06-02 18:50:40");
INSERT INTO Reviews (truckName, userName, rating, comment, createdAt, updatedAt) VALUES ("A Night In Paris", "House", 1, "You should be paying me to eat here.", "2019-06-02 18:50:40", "2019-06-02 18:50:40");
INSERT INTO Reviews (truckName, userName, rating, comment, createdAt, updatedAt) VALUES ("A Night In Paris", "Wilson", 3, "Fabulous wine selection.", "2019-06-02 18:50:40", "2019-06-02 18:50:40");
...
INSERT INTO Reviews (truckName, userName, rating, comment, createdAt, updatedAt) VALUES ("Jen's Pizza", "Deepak", 2, "I prefer Soma Pizza.", "2019-06-02 18:50:40", "2019-06-02 18:50:40");
...
INSERT INTO Reviews (truckName, userName, rating, comment, createdAt, updatedAt) VALUES ("Mice-Cream Truck", "George", 2, "Their ice cream is great, but not worth a 50 minute wait.", "2019-06-02 18:50:40", "2019-06-02 18:50:40");